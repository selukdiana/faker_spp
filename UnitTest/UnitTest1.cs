...
namespace UnitTest
{
    ...
    public class UserFieldsTest
    {
        ...
        {
            Assert.AreEqual(user.name.GetType() == typeof(string), true, "÷¸");
        }
        [TestMethod]
        public void AgeFieldTest()
        {
            Assert.AreEqual(user.age.GetType() == typeof(int), true, "÷¸");
        }
        [TestMethod]
        public void DateFieldTest()
        {
            Assert.AreEqual(user.date.GetType() == typeof(DateTime), true, "÷¸");
        }
        ...
        public void DogNameTest()
        {
                ...
                Assert.AreEqual(user.dogs[0].name.GetType() ==typeof(string), true, "÷¸");
